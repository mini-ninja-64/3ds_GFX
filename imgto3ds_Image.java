...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            img = ImageIO.read(new File("C:\\Users\\callum\\Desktop\\space_xd.png"));
        } catch (IOException e) {
        }
        ...
        FileOutputStream fos = new FileOutputStream("C:\\Users\\callum\\Desktop\\space_xd.3ds_Image");
        fos.write(fileBuff);
        fos.close();
    }
}
